  ...
  return (
    <footer className="relative overflow-hidden">
      ...
      <div className="text-white">
        ...
        <div className="relative z-10 mx-auto grid max-w-screen-xl grid-cols-1 px-6 py-6 md:grid-cols-3 md:px-10 lg:px-12">
      ...
      <div className="relative bg-black text-white">
        ...
        <div className="relative mx-auto max-w-screen-xl px-6 py-14 md:px-10 lg:px-12">
          ...
          {/* BOTTOM BAR */}
          <div className="mt-12 flex border-t border-white/10 pt-6 text-sm text-white/70 md:items-center md:justify-center">
