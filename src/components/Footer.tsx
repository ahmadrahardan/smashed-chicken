  ...
  return (
    <footer className="relative overflow-hidden">
      ...
      <div className="relative text-white">
        ...
        <div className="relative z-10 mx-auto grid max-w-screen-xl grid-cols-[auto_1fr] gap-x-4 gap-y-5 px-6 py-6 md:grid-cols-3 md:px-10 lg:px-12">
          {/* JAM OPERASIONAL */}
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-lg font-semibold leading-tight">Setiap Hari</p>
          ...
          {/* HUBUNGI KAMI */}
          <div className="col-span-2 flex items-start gap-4 md:col-span-1 md:justify-end">
            <div>
              <p className="text-lg font-semibold leading-tight">
                Hubungi Kami
              </p>
            ...
            <div className="space-y-1 text-sm sm:text-base">
              <div className="flex items-center gap-2">
                <a
                  href="https://wa.me/6281913223450"
                  target="_blank"
                ...
                >
                  ...
                  <span>0819-1322-3450</span>
                </a>
              </div>

              <div className="flex items-center gap-2">
                <a
                  href="https://www.instagram.com/ayamgeprekabang.jember"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 hover:text-red-300 transition-colors"
                >
                  ...
                  <span>@ayamgeprekabang.jember</span>
                </a>
              </div>
            </div>
          </div>
      ...
      <div className="relative bg-black text-white">
        ...
        <div className="relative mx-auto max-w-screen-xl px-6 py-4 md:px-10 md:py-8 lg:px-12">
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 md:gap-10 lg:grid-cols-4">
            ...
            <div>
              <h3 className="mb-5 text-lg font-semibold">Alamat</h3>
              <ul className="space-y-3 text-sm leading-7 text-white/80">
                <li>
                  Jl. Imam Bonjol, Tegal Besar Kulon, Tegal Besar, Kec.
                  Kaliwates, Kab. Jember 68131 (Seberang MTsN 1 Jember)
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm leading-7 text-white/80">
                <li>0819-1322-3450</li>
              </ul>
            </div>
          </div>
        </div>
        <div className="mt-8 border-t border-white/60 md:mt-12">
          <div className="mx-auto flex max-w-screen-xl justify-center px-6 py-5 text-sm text-white/70 md:px-10 md:py-6 lg:px-12">
            <p>© 2026 Ayam Geprek Abang. All rights reserved</p>
          </div>
        </div>
      </div>
    </footer>
